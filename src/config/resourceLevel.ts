...
> = {
  food: {
    1: {totalAmount: 110_000, miningSpeed: 1000, restoreTime: 24 * 60 * 60 * 1000}, 
  ...
  wood: {
    1: {totalAmount: 100_000, miningSpeed: 940, restoreTime: 24 * 60 * 60 * 1000}, 
  ...
  iron: {
    1: {totalAmount: 60_000, miningSpeed: 800, restoreTime: 24 * 60 * 60 * 1000},
  ...
  gold: {
    1: {totalAmount: 25_000, miningSpeed: 700, restoreTime: 24 * 60 * 60 * 1000},
  ...
  pearl: {
    1: {totalAmount: 5_000, miningSpeed: 500, restoreTime: 24 * 60 * 60 * 1000},
